...
function Header() {
    ...
    return (
        ...
        <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-transparent backdrop-blur-xl shadow-lg shadow-black/20">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    <Link href="/" className="flex items-center space-x-1 group">
                        ...
                        <Image src="/next-step-logo.png" alt="NextStep Logo" width={50} height={50} className="size-12" />
                    ...
                    <div className="hidden md:flex items-center justify-center">
                        ...
                        {user && (
                            <Link href="/quiz" legacyBehavior passHref>
                                <div className="group inline-flex h-10 w-max items-center justify-center rounded-xl bg-transparent px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-200 backdrop-blur-sm">
